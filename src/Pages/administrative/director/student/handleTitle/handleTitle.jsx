...
export const HandleTitle = () => {
    const myUrls = [
        process.env.REACT_APP_MIDDLEWARE_URL_BASE + '/role/director/handleTitle/userHasTitle',
        process.env.REACT_APP_MIDDLEWARE_URL_BASE + '/role/director/handleTitle/userHasTitle/title',
    ];
