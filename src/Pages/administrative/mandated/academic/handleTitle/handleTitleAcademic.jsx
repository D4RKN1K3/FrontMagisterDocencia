...
export const HandleTitleAcademic = () => {
    const myUrls = [
        process.env.REACT_APP_MIDDLEWARE_URL_BASE + '/role/mandated/handleTitle/bodyAcademic',
        process.env.REACT_APP_MIDDLEWARE_URL_BASE + '/role/mandated/handleTitle/bodyAcademic/title',
    ];
