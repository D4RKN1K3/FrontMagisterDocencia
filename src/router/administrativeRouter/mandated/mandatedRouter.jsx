...
import { HandleTitleAcademic } from '../../../Pages/administrative/mandated/academic/handleTitle/handleTitleAcademic';
...
import { PreliminaryProject } from '../../../Pages/administrative/mandated/specialization/preliminaryProject';
import { Thesis } from '../../../Pages/administrative/mandated/specialization/Thesis';
  ...
  return (
    <Routes>
      <Route path="/">
        ...
        <Route path="PreliminaryProject" element={<PreliminaryProject />} />
