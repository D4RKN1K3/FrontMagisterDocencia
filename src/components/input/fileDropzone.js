...
const FileDropzone = ({ onFileChange }) => {
    ...
    return (
        <div {...getRootProps()} className="flex items-center justify-center w-full">
            <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center text-center w-full h-26 sm:h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100 text-gray-500 hover:text-gray-600">
                <div className="flex flex-col items-center justify-center pt-5 py-6">
                    ...
                    <ul className="text-start list-disc pl-4 text-xs text-gray-500">
                        <li>Imágenes: .png, .jpg</li>
                        <li>Documentos: .xls, .doc</li>
                        <li>Archivos PDF: .pdf</li>
                    </ul>
                </div>
            </label>
        </div>
