        ...
        <section className="bg-white text-orange-500">
            <div className="mx-auto max-w-screen-xl px-4 pb-2 sm:pb-4 sm:px-3 lg:pb-6 lg:px-2">
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="text-3xl font-bold tracki text-center sm:text-4xl text-orange-400">{title}</h2>
                    ...
                    {sections.map((section, index) => (
                        ...
                        >
                            <div className="h-10 flex flex-row justify-center items-center w-full">
                                {section.icon}
                                <h2 className="text-xl font-bold text-center text-gray-900">{section.title}</h2>
                            </div>
