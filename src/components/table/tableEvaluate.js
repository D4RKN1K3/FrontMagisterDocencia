...
const TableEvaluate = ({ items, specializationHasStudent, fetchRubric }) => {
    return (
        <div className="bg-white text-gray-100">
            {items.map((item) => (
                <div key={item.evaluateID} className="container max-w px-2 sm:px-6 py-6 mx-auto rounded-lg shadow-md bg-white">
                    ...
                    <div className="grid grid-cols-4 items-center justify-between mt-2 sm:mt-4 space-y-4 sm:space-y-0">
                        <div className='flex flex-col sm:flex-row sm:col-span-2 col-span-full gap-2 justify-start sm:justify-start'>
                            {(specializationHasStudent.typeEvaluateID === 1) &&
                                <>
                                    {(item.stageID === 1) && (
                                        <>
                            ...
                            {(specializationHasStudent.typeEvaluateID === 2) &&
                                <>
                                    {(item.stageID === 1) && (
                                        <>
                                            <div className="flex items-center justify-center sm:justify-start max-w-3xl col-span-full sm:col-span-3">
                                                ...
                                                <span className="text-gray-500">{specializationHasStudent.director_fullName}</span>
                                            </div>
                                            <div className="flex items-center justify-center sm:justify-start max-w-3xl col-span-full sm:col-span-3">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <span className="text-gray-500">{specializationHasStudent.codirector_fullName}</span>
                                            </div>
                                        </>
                                    )}
                                </>}
                        ...
                        <div className='flex flex-col sm:flex-row sm:col-span-2 col-span-full gap-2'>
                            ...
                            <div className="flex-1">
                                <CustomButton onClick={() => fetchRubric(item.evaluateID)} type='button' color='orange' padding_x='4' padding_smx='6' padding_mdx='8' padding_y='2' width='full' height='full'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
